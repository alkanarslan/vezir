      ...
      <q-toolbar>
        ...
        <div class="q-gutter-sm row items-center no-wrap">
          ...
          <q-btn round flat>
            ...
            <q-tooltip>{{ getMe.name + "-" + getMe.email }}</q-tooltip>
          </q-btn>
        </div>
      </q-toolbar>
    </q-header>
...
export default {
  ...
  setup() {
    ...
    return {
      ...
      links2: [
        { icon: "folder", text: "Home" },
        { icon: "restore", text: "Home" },
        { icon: "watch_later", text: "Home Home" },
        { icon: "thumb_up_alt", text: "Liked videos" },
      ],
      links3: [
        { icon: fabYoutube, text: "vezir Premium" },
      ...
      links4: [
        ...
        { icon: "fa fa-address-card", text: "Report history" },
        { icon: "help", text: "Help" },
