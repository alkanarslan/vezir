...
public class TokenService : ITokenService
{
    ...
    public TokenService(VezirApiContext vezirApiContext)
    {
        this._vezirApiContext = vezirApiContext;
    }
    ...
    public async Task<bool> RemoveRefreshTokenAsync(User user)
    {
        ...
        if (userRecord.RefreshTokens != null && userRecord.RefreshTokens.Any())
        {
            ...
            _vezirApiContext.RefreshTokens.Remove(currentRefreshToken);
        }
    ...
    {
        var refreshToken =
            await _vezirApiContext.RefreshTokens.FirstOrDefaultAsync(o => o.UserId == refreshTokenRequest.UserId);
        ...
        var refreshTokenToValidateHash = PasswordHelper.HashUsingPbkdf2(refreshTokenRequest.RefreshToken,
